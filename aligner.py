...
def similarity(source, target):
	logger.logger.debug('INPUT SOURCE <' + source + '>')
	logger.logger.debug('INPUT TARGET <' + source + '>')
	...
	logger.logger.log(logger.details, 'OUTPUT <' + str(score) + '>')
	return score
...
def align(sourcegraph, targetgraph):
	...
	logger.logger.info('OUTPUT ALIGNMENT <' + str(alignment) + '>')
	logger.logger.info('OUTPUT VALUE <' + str(problem.objective.value()) + '>')
